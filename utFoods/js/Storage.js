...
var drop_sports_table_statement = ' DROP TABLE IF EXISTS sports ';
...
var create_sports_table_statement = 'CREATE TABLE sports(\
  id	INTEGER,\
  id_user	INTEGER,\
  sport	TEXT,\
  duration	TEXT,\
